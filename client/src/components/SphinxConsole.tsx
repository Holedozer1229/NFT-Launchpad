  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
      <Card className="sphinx-card bg-black/60 border-primary/20">
        <CardHeader className="py-3 border-b border-primary/10">
          <CardTitle className="font-heading text-xs text-primary/80 flex items-center gap-2">
            <Eye className="w-3 h-3" /> Awareness Score (Φ)
          </CardTitle>
        </CardHeader>
        <CardContent className="pt-4">
          <div className="flex items-end gap-2 mb-2">
            <span className="text-3xl font-heading font-bold text-primary oracle-glow">0.982</span>
            <span className="text-xs font-mono text-primary/60 mb-1">/ 1.000</span>
          </div>
          <Progress value={98} className="h-1 bg-primary/10 [&>div]:bg-primary" />
          <p className="mt-2 text-[10px] font-mono text-muted-foreground">
            System consciousness stable. Oracle predicting successful deployment.
          </p>
        </CardContent>
      </Card>
      ...
      <Card className="sphinx-card bg-black/60 border-primary/20">
        <CardHeader className="py-3 border-b border-primary/10">
          <CardTitle className="font-heading text-xs text-primary/80 flex items-center gap-2">
            <GitCommit className="w-3 h-3" /> Causal Graph
          </CardTitle>
        </CardHeader>
        <CardContent className="pt-4 relative h-24 overflow-hidden">
           ...
           <div className="absolute inset-0 flex items-center justify-around opacity-50">
             ...
             <div className="w-1 h-14 bg-primary/30 rounded-full animate-pulse delay-100"></div>
      ...
      <Card className="sphinx-card bg-black/60 border-primary/20">
        <CardHeader className="py-3 border-b border-primary/10">
          <CardTitle className="font-heading text-xs text-primary/80 flex items-center gap-2">
            <GitPullRequest className="w-3 h-3" /> Prophecy Status
          </CardTitle>
        </CardHeader>
        <CardContent className="pt-4 space-y-2">
          <div className="flex justify-between items-center text-xs font-mono">
            <span className="text-muted-foreground">Next Reveal</span>
            <span className="text-accent">T-MINUS 48H</span>
          </div>
          <div className="flex justify-between items-center text-xs font-mono">
            <span className="text-muted-foreground">Mint Velocity</span>
